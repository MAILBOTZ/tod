// SC BY BANG ARYA KEMCE
// MAU NO ENC? TEMBUSIN 500SUBS GUA BAKAL UP SC NO PW+NO ENC
// NO WA GUA?:v wa.me/62895340972894
// INGATT, LU HANYA RECODE DOANG JADI JANGAN HAPUS TTQ NYA 
const
	{
...
try {
        ...
        mess = {
			...
			only: {
				...
				ownerG: 'khusus admin grup',
				ownerB: 'khusus bang arya yang kemce😎',
				admin: 'khusus admin grup',
				Badmin: 'bot jadiin admin dlu jir'
			}
		}
		...
		const katalog = (teks) => {
             res = pemuda.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© MAIL BOTZ_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             pemuda.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = pemuda.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_© MAIL BOTZ_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
pemuda.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© MAIL BOTZ_*", [{buttonId: 'simi', buttonText: {disText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
pemuda.updatePresence(from, Presence.recording)
   ...
   const sotoy = [
     ...
     case "5b017c6ac1fb953c7bd21034d2fca5fad75ef2da4c3b2c2877ef49fa544e74bf":
        ...
        case 'menu':
        case 'help':
        ptod = "62895340972894@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from, `${menu}`, `BANG ARYA KEMCE`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}allmenu`,buttonText:{displayText:'MENU ALL'},type:1},{buttonId:`${prefix}sewabot`,buttonText:{displayText:'SEWABOT'},type:1},{buttonId:`${prefix}ping`,buttonText:{displayText:'SPEED'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'allmenu':
        ptod = "62895340972894@s.whatsapp.net"
        stod = `${sender}`
...
│❏  ${prefix}dadu
└─────────────────⬣`
sendButLocation(from, `${menu}`, `BANG ARYA KEMCE`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}command`,buttonText:{displayText:'COMMAND'},type:1},{buttonId:`${prefix}sewabot`,buttonText:{displayText:'SEWABOT'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'credits':
case 'credit':
taggg =`
...
👑 ◪• ARYA GANZ ⟨ @62895340972894 ⟩
👑 ◪• MAIL BOTZ ⟨ @6285867135814 ⟩`
mentions(taggg, [`6285721599053@s.whatsapp.net`,`6285846098802@s.whatsapp.net`,`62895340972894@s.whatsapp.net`,`6285867135814@s.whatsapp.net`], true)
break
case 'sewabot':
sewa1 = `
┏━━⬣ PRICE LIST 1
...
┏━━⬣ MINAT? PM
┃⬡ wa.me/62895340972894
┗━━⬣
NB : BOT TIDAK ON 24 JAM`
reply(sewa1)
break
case 'antilink':
haibg =`Hai Kak ${pushname}\nSilahkan Pilih Mode Antilink Dibawah`
               buttons = [{buttonId: `${prefix}antilinky 1`,buttonText:{displayText: 'ANTILINK ON'},type:1},{buttonId:`${prefix}antilinky 0`,buttonText:{displayText:'ANTILINK OFF'},type:1}]
               buttonsMessage = { contentText: `${haibg}`, footerText: 'ARYA KEMCE', buttons: buttons, headerType: 1 }
...
case 'command':
 listMsg = {
 buttonText: 'MENU MAIL BOTZ',
 footerText: '*_© MAIL BOTZ_*',
 description: `Hai kak, saya mail botz, Silahkan pilih menu mail dibawah ini ya kak, Kalau kakak menggunakan wa gb, dan gak muncul, Ketik .allmenu saja kak >_<`,
 sections: [
                     {
...
pemuda.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid },quoted:ftrol})
break
case 'ownermenu':
menu = `⬣ 「 \`\`\`MENU OWNER\`\`\` 」
├────────────────────
...
│❏  ${prefix}bughole
└─────────`
sendButLocation(from, `${menu}`, `BANG ARYA KEMCE`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}ping`,buttonText:{displayText:'SPEED'},type:1},{buttonId:`${prefix}credit`,buttonText:{displayText:'THANKS TO'},type:1}], {contextInfo: { mentionedJid: []}})
break
case 'downloadmenu':
menu = `⬣ 「 \`\`\`MENU DOWNLOAD\`\`\` 」
├────────────────────
...
//Done
case 'jadibot':
reply('FITUR INI TELAH DI HAPUS OLEH OWNER BWAHAHAHAHA')
break
case 'stopjadibot':
...
break
		...
		case 'sc':
		case 'sourcecode':
		pemuda.sendMessage(from, { text: "GUA AJA USAHA MASA ELU KAGA", matchedText: 'https://youtu.be/TaG15W_8f_s', description: "", title: "don't click here !!!", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
       case 'debug':
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          ...
          "url": "GUA AJA USAHA MASA ELU KAGA"
        },
        "index": 0
      }
    ]
...
case 'joinn':
    if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
            ...
            var response = await pemuda.acceptInvite(codeInvite)
            fakestatus('SUKSES')
            } catch {
...
case 'x':
        ...
        if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
        pemuda.toggleDisappearingMessages(from, 0)
        sendButLocation(from, `${ngazap(prefix)}`, `${virtag(prefix)}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}bbaij72njnwjibdo16830nslm1782`,buttonText:{disText:'⚔️ MAIL BOTZ ⚔️'},type:1}])
        pemuda.toggleDisappearingMessages(from, 0)
break
case 'bugrow':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
